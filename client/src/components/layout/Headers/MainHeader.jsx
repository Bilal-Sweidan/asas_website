...
export default function MainHeader() {
    ...
    return (
        <header className='text-nowrap d-flex justify-content-between' style={{ padding: "0 5rem", backgroundColor: "#2D5356" }}>
            ...
            <div className=' text-nowrap gap-4 center px-5 text-capitalize' style={{ backgroundColor: "#C79426", borderRadius: "0 0 15px 15px" }} dir={language == "ar" ? "rtl" : "ltr"}>
