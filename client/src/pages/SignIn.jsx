        ...
        <>
            {
                <section className="main-section text-light d-flex " style={{ backgroundColor: "" }}>
                    <div className="vh-100 d-flex px-3 py-2 w-50">
                        ...
                        <div className='w-75 h-75 px-3'>
                            ...
                            <form action="" method='dialog' className='px-3' onSubmit={async (e) => {
                                ...
                                <div className='mb-3 position-relative'>
                                    ...
                                    <input type="text" name="email" id="" placeholder='enter your email' className='form-control' style={{ padding: "13px", backgroundColor: "#00101c54", color: "white" }} />
                                </div>
                                <div >
